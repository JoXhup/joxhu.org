...
function Calendar({ className, classNames, showOutsideDays = true, ...props }) {
    return (
        <DayPicker
            ...
            className={cn("p-3 bg-zinc-950 border border-zinc-800 rounded-md", className)}
            classNames={{
                ...
                nav_button: cn(
                    ...
                    "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 border-zinc-800 text-zinc-100"
                ),
                ...
                day: cn(
                    ...
                    "h-8 w-8 p-0 font-normal aria-selected:opacity-100 text-zinc-400 hover:bg-zinc-800 hover:text-zinc-100"
                ),
                day_range_start: "day-range-start",
                day_range_end: "day-range-end",
                day_selected: "bg-zinc-100 text-zinc-950 hover:bg-zinc-100 hover:text-zinc-950 focus:bg-zinc-100 focus:text-zinc-950",
                day_today: "bg-zinc-800 text-zinc-100",
                day_outside: "day-outside text-zinc-600 aria-selected:bg-zinc-800/50 aria-selected:text-zinc-400",
